...
namespace SpecFlowProject2.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("AddAllProducts")]
    public partial class AddAllProductsFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "AddAllProducts", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("standard_user", "secret_sauce", "YES", "YES", "YES", "YES", "YES", "YES", "Ana", "Silva", "11010-123", "CHECKOUT: COMPLETE!", "THANK YOU FOR YOUR ORDER", "129.94", "10.4", "140.34", null)]
        public virtual void AddAllProducts(
                    string username, 
                    string password, 
                    string t_Shirt, 
                    string backpack, 
                    ...
                    string lastName, 
                    string zipCode, 
                    string checkoutCompleteMessage, 
                    ...
                    string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Item Total", itemTotal);
            argumentsOfScenario.Add("Tax", tax);
            argumentsOfScenario.Add("Total", total);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("AddAllProducts", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 4
...
#line 6
    testRunner.When("the user fills the mandatory fields", ((string)(null)), table1, "When ");
#line hidden
#line 9
...
#line 10
 testRunner.And("The user selects more than one products in the chart", ((string)(null)), table2, "And ");
#line hidden
...
#line 13
 testRunner.And("The user makes the checkout", ((string)(null)), table3, "And ");
#line hidden
#line 16
 testRunner.Then(string.Format("The system shows the Item total: \'{0}\', The Tax \'{1}\' and the Final Total \'{2}\'", itemTotal, tax, total), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 17
